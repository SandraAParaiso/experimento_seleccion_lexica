...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/sandra/Desktop/s_lexica/untitled_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    # --- Initialize components for Routine "intrucciones_prueba" ---
    text = visual.TextStim(win=win, name='text',
        text='ENSAYOS DE PRUEBA (no se tendrán en cuenta en el experimento).\n\nDe todos los objetos con peso menor a 500 gr marque 1 si el que aparece se nombra en femenino ej. ‘la pala’ vs ‘el pelo’. Pulse ESPACIO para continuar.',
        font='Open Sans',
    ...
    # --- Initialize components for Routine "prueba_uno" ---
    ...
    # --- Initialize components for Routine "i_cond_uno" ---
    text_5 = visual.TextStim(win=win, name='text_5',
        text='CONDICIÓN EXPERIMENTAL UNO.\n\nDe todos los objetos con peso menor a 500 gr marque 1 si el que aparece se nombra en femenino ej. ‘la pala’ vs ‘el pelo’. Pulse ESPACIO para continuar.',
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    # --- Initialize components for Routine "condicion_uno" ---
    ...
    # --- Initialize components for Routine "insprubdos" ---
    text_3 = visual.TextStim(win=win, name='text_3',
        text='ENSAYOS DE PRUEBA (no se tendrán en cuenta en el experimento).\n\nDe todos los objetos con nombre femenino marque 1 si el que aparece pesa menos de 500 gramos ej. ‘la pala’ vs ‘la casa’. Pulse ESPACIO para continuar.',
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    # --- Initialize components for Routine "prueba_dos" ---
    ...
    # --- Initialize components for Routine "ins_cond_dos" ---
    text_4 = visual.TextStim(win=win, name='text_4',
        text='CONDICIÓN EXPERIMENTAL 2.\n\nDe todos los objetos con nombre femenino marque 1 si el que aparece pesa menos de 500 gramos ej. ‘la pala’ vs ‘la casa’. Pulse ESPACIO para continuar.',
        font='Open Sans',
        pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
        color='white', colorSpace='rgb', opacity=None, 
        languageStyle='LTR',
    ...
    # --- Initialize components for Routine "condicion_dos" ---
    ...
    # --- Prepare to start Routine "intrucciones_prueba" ---
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('intrucciones_prueba.started', globalClock.getTime())
    key_resp.keys = []
    key_resp.rt = []
    _key_resp_allKeys = []
    # keep track of which components have finished
    intrucciones_pruebaComponents = [text, key_resp]
    for thisComponent in intrucciones_pruebaComponents:
    ...
    # --- Run Routine "intrucciones_prueba" ---
    ...
    # --- Ending Routine "intrucciones_prueba" ---
    for thisComponent in intrucciones_pruebaComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('intrucciones_prueba.stopped', globalClock.getTime())
    # check responses
    ...
    thisExp.nextEntry()
    # the Routine "intrucciones_prueba" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    
    # set up handler to look after randomisation of conditions etc
    trials = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('seleccion_semantica_prueba.xlsx'),
    ...
    for thisTrial in trials:
        ...
        # --- Prepare to start Routine "prueba_uno" ---
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('prueba_uno.started', globalClock.getTime())
        image.setImage(puno)
        key_resp_2.keys = []
        key_resp_2.rt = []
        _key_resp_2_allKeys = []
        # keep track of which components have finished
        prueba_unoComponents = [polygon, image, key_resp_2]
        for thisComponent in prueba_unoComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        while continueRoutine:
            ...
            if key_resp_2.status == STARTED and not waitOnFlip:
                ...
                if len(_key_resp_2_allKeys):
                    ...
                    # was this correct?
                    if (key_resp_2.keys == str('rpuno')) or (key_resp_2.keys == 'rpuno'):
                        key_resp_2.corr = 1
                    else:
                        key_resp_2.corr = 0
                    # a response ends the routine
        ...
        # --- Ending Routine "prueba_uno" ---
        for thisComponent in prueba_unoComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('prueba_uno.stopped', globalClock.getTime())
        # check responses
        if key_resp_2.keys in ['', [], None]:  # No response was made
            key_resp_2.keys = None
            # was no response the correct answer?!
            if str('rpuno').lower() == 'none':
        ...
        # the Routine "prueba_uno" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        thisExp.nextEntry()
    ...
    # --- Prepare to start Routine "i_cond_uno" ---
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('i_cond_uno.started', globalClock.getTime())
    key_resp_8.keys = []
    key_resp_8.rt = []
    _key_resp_8_allKeys = []
    # keep track of which components have finished
    i_cond_unoComponents = [text_5, key_resp_8]
    for thisComponent in i_cond_unoComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    # --- Ending Routine "i_cond_uno" ---
    for thisComponent in i_cond_unoComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('i_cond_uno.stopped', globalClock.getTime())
    # check responses
    ...
    thisExp.nextEntry()
    # the Routine "i_cond_uno" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    
    # set up handler to look after randomisation of conditions etc
    trials_3 = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('seleccion_semantica.xlsx'),
    ...
    for thisTrial_3 in trials_3:
        ...
        # --- Prepare to start Routine "condicion_uno" ---
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('condicion_uno.started', globalClock.getTime())
        image_3.setImage(conduno)
        key_resp_4.keys = []
        key_resp_4.rt = []
        _key_resp_4_allKeys = []
        # keep track of which components have finished
        condicion_unoComponents = [polygon_2, image_3, key_resp_4]
        for thisComponent in condicion_unoComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        while continueRoutine:
            ...
            if key_resp_4.status == STARTED and not waitOnFlip:
                ...
                if len(_key_resp_4_allKeys):
                    ...
                    # was this correct?
                    if (key_resp_4.keys == str('runo')) or (key_resp_4.keys == 'runo'):
                        key_resp_4.corr = 1
                    else:
                        key_resp_4.corr = 0
                    # a response ends the routine
        ...
        # --- Ending Routine "condicion_uno" ---
        for thisComponent in condicion_unoComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('condicion_uno.stopped', globalClock.getTime())
        # check responses
        if key_resp_4.keys in ['', [], None]:  # No response was made
            key_resp_4.keys = None
            # was no response the correct answer?!
            if str('runo').lower() == 'none':
        ...
        # the Routine "condicion_uno" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        thisExp.nextEntry()
    ...
    # --- Prepare to start Routine "insprubdos" ---
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('insprubdos.started', globalClock.getTime())
    key_resp_6.keys = []
    key_resp_6.rt = []
    _key_resp_6_allKeys = []
    # keep track of which components have finished
    insprubdosComponents = [text_3, key_resp_6]
    for thisComponent in insprubdosComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    # --- Ending Routine "insprubdos" ---
    for thisComponent in insprubdosComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('insprubdos.stopped', globalClock.getTime())
    # check responses
    ...
    thisExp.nextEntry()
    # the Routine "insprubdos" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    ...
    for thisTrial_2 in trials_2:
        ...
        # --- Prepare to start Routine "prueba_dos" ---
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('prueba_dos.started', globalClock.getTime())
        image_2.setImage(pdos)
        key_resp_3.keys = []
        key_resp_3.rt = []
        _key_resp_3_allKeys = []
        # keep track of which components have finished
        prueba_dosComponents = [polygon_3, image_2, key_resp_3]
        for thisComponent in prueba_dosComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        while continueRoutine:
            ...
            if key_resp_3.status == STARTED and not waitOnFlip:
                ...
                if len(_key_resp_3_allKeys):
                    ...
                    # was this correct?
                    if (key_resp_3.keys == str('rpdos')) or (key_resp_3.keys == 'rpdos'):
                        key_resp_3.corr = 1
                    else:
                        key_resp_3.corr = 0
                    # a response ends the routine
        ...
        # --- Ending Routine "prueba_dos" ---
        for thisComponent in prueba_dosComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('prueba_dos.stopped', globalClock.getTime())
        # check responses
        if key_resp_3.keys in ['', [], None]:  # No response was made
            key_resp_3.keys = None
            # was no response the correct answer?!
            if str('rpdos').lower() == 'none':
        ...
        # the Routine "prueba_dos" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        thisExp.nextEntry()
    ...
    # --- Prepare to start Routine "ins_cond_dos" ---
    continueRoutine = True
    # update component parameters for each repeat
    thisExp.addData('ins_cond_dos.started', globalClock.getTime())
    key_resp_7.keys = []
    key_resp_7.rt = []
    _key_resp_7_allKeys = []
    # keep track of which components have finished
    ins_cond_dosComponents = [text_4, key_resp_7]
    for thisComponent in ins_cond_dosComponents:
        thisComponent.tStart = None
        thisComponent.tStop = None
        thisComponent.tStartRefresh = None
        thisComponent.tStopRefresh = None
    ...
    # --- Ending Routine "ins_cond_dos" ---
    for thisComponent in ins_cond_dosComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thisExp.addData('ins_cond_dos.stopped', globalClock.getTime())
    # check responses
    ...
    thisExp.nextEntry()
    # the Routine "ins_cond_dos" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    ...
    for thisTrial_4 in trials_4:
        ...
        # --- Prepare to start Routine "condicion_dos" ---
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('condicion_dos.started', globalClock.getTime())
        image_4.setImage(conddos)
        key_resp_5.keys = []
        key_resp_5.rt = []
        _key_resp_5_allKeys = []
        # keep track of which components have finished
        condicion_dosComponents = [polygon_4, image_4, key_resp_5]
        for thisComponent in condicion_dosComponents:
            thisComponent.tStart = None
            thisComponent.tStop = None
            thisComponent.tStartRefresh = None
            thisComponent.tStopRefresh = None
        ...
        while continueRoutine:
            ...
            if key_resp_5.status == STARTED and not waitOnFlip:
                ...
                if len(_key_resp_5_allKeys):
                    ...
                    # was this correct?
                    if (key_resp_5.keys == str('rdos')) or (key_resp_5.keys == 'rdos'):
                        key_resp_5.corr = 1
                    else:
                        key_resp_5.corr = 0
                    # a response ends the routine
        ...
        # --- Ending Routine "condicion_dos" ---
        for thisComponent in condicion_dosComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('condicion_dos.stopped', globalClock.getTime())
        # check responses
        if key_resp_5.keys in ['', [], None]:  # No response was made
            key_resp_5.keys = None
            # was no response the correct answer?!
            if str('rdos').lower() == 'none':
        ...
        # the Routine "condicion_dos" was not non-slip safe, so reset the non-slip timer
        routineTimer.reset()
        thisExp.nextEntry()
    ...
    # keep track of which components have finished
    AgradecimientoComponents = [text_2]
